...
function template_customMusic_edit_playlist()
{
	...
	<form action="'. $context['post_url']. '" method="post" accept-charset="'. $context['character_set']. '" name="myselect" id="myselect">		
		<div class="cat_bar"><h4 class="catbg" style="text-align:center;">' . $txt['premiumbeat_edit_list']. $context['mysets']['myplaylist'] . '</h4></div>
		<br /><br />		
		<table border="0" cellspacing="0" cellpadding="4" width="100%">
			<tr class="titlebg" style="font-size:x-small;">
				<td class="catbg" style="border:0px;border-bottom: thin outset;height: 23px;background: url(',$settings['actual_theme_url'],'/images/theme/main_block.png) no-repeat 0 -160px;">' . $txt['customMusic_playlist_data'] . '</td>
			...
			<tr>
				...
				<td class="windowbg" style="text-align:left;"><input type="text" name="title[]" value="'.$context['mysets']['title'].'" class="text" maxlength="60" size="40" /></td>
			</tr>	
			<tr>
				<td class="windowbg" width="15%" style="text-align:left;">', $txt['premiumbeat_height'], '</td>
				<td class="windowbg" width="15%" style="text-align:left;"><input type="text" name="height[]" value="'.$context['mysets']['height'].'" class="text" maxlength="4" size="4" /></td>
			</tr>		
			<tr>
		...
		echo '
			<tr>
				...
				<td class="windowbg" width="17%" style="text-align:left;">
					...
					<input type="radio" id="equipY" name="equip[]" value="2" onclick="changeTypeY();" />
		...
		echo '
			<tr>
				...
				<td class="windowbg" width="17%" style="text-align:left;">
					...
					<input type="radio" id="equipY" name="equip[]" value="2" onclick="changeTypeY();" checked="checked" />
						<span id="updateEquip">',$context['equip'],'</span>
				</td>
			</tr>';	
	...
	echo '
			<tr>
				<td class="windowbg" width="15%" style="text-align:top left;">',$txt['premiumbeat_file_title'],'</td>
			...
			<tr>
				<td class="windowbg" colspan="2">
					<div style="text-align:top;">
						<div style="float:left;">',$txt['premiumbeat_playlist_perm1'],'<strong>',$context['id_group'],'</strong></div>
					</div>
				</td>
			</tr>';
	}									
	echo '
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%" style="visibility:hidden;font-size:small;font-family:serif;" id="perm1">
			<tr>
				<td>&nbsp;</td>
			</tr>
			<tr>
			...
			<tr>
				<td>',$txt['premiumbeat_playlist_perm2'],'</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>';	
	...
	echo '
			<tr>
				<td>
					<input type="checkbox" value="-1" id="perms_guest" name="perms[]" />&nbsp;', $txt['guest_title'], '
				</td>
			</tr>
			<tr>
				<td>
					<input type="checkbox" value="-999" id="perms_admin" name="perms[]" />&nbsp;', $txt['premiumbeat_na'], '
				</td>
			</tr>
			<tr>
				<td style="font-size:xx-small;">
					<input type="checkbox" name="Check_All" value="Check All"
						onClick="Check(document.myselect[';
						echo "'perms[]'";
		...
		<table border="0" cellspacing="0" cellpadding="4" width="100%">
			...
			<tr>
				<td class="windowbg" colspan="6" style="text-align:center;">
					<a href="' . $scripturl . '?action=admin;area=premiumbeat;sa=BrowsePremiumbeat;' . $context['session_var'] . '=' . $context['session_id'] . ';">'.$txt['premiumbeat_return'] . '</a>
				</td>
			</tr>
		</table>				
